...
use App\Actions\Inventory\UniqueStock\ShowUniqueStockInCustomer;
use App\Actions\Inventory\UniqueStock\ShowUniqueStockInTenant;
...
class UniqueStockController extends Controller
{
    ...
    */
    ...
    public function indexUniqueStockInCustomer(Shop $shop, Customer $customer): Response
    {
        return IndexUniqueStockInCustomer::make()->asInertia($customer);
    }

    public function showUniqueStockInTenant(UniqueStock $uniqueStock): Response
    {
