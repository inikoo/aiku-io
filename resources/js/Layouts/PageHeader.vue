        ...
        <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                ...
                <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                    <div v-for="meta in headerData['meta']" class="mt-2 flex items-center text-sm text-gray-500">
                        <font-awesome-icon :icon="meta.icon" class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" aria-hidden="true"/>
                        {{ meta.name }}
                    </div>
                </div>
            </div>
