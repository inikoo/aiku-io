<!--
  ...
  -  Created: Tue, 18 Jan 2022 01:03:52 Malaysia Time, Kuala Lumpur, Malaysia
...
<template>
    <Switch v-model="enabled"
            :class="[enabled ? 'bg-green-600 focus:ring-green-100' : 'bg-red-600 focus:ring-red-100', 'relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ']">
